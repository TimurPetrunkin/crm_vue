...
import { COLLECTIONS_CUSTOMERS, DB_ID, STORAGE_ID } from '~/app.constants'
...
const { data, isSuccess } = useQuery({
	...
	queryFn: () => DB.getDocument(DB_ID, COLLECTIONS_CUSTOMERS, customerId),
})
...
const { mutate, isPending } = useMutation({
	...
	mutationFn: (data: ICustomerFormState) =>
		DB.updateDocument(DB_ID, COLLECTIONS_CUSTOMERS, customerId, data),
})
